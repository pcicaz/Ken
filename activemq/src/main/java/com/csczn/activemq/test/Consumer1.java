...
public class Consumer1 {
    private static Log logger = LogFactory.getLog(Consumer1.class);
...
//        Destination destination = session.createQueue("test.queue?consumer.priority=11");//创建消息目标(点对点模型队列)
